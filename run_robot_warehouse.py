...
# from envs.env_rware import Env
from envs.env_robot_warehouse import Env
...
parser.add_argument('--online_buffer_size', type=int, default=1)
...
logger.info(f"args.eval_episodes:{args.eval_episodes}")
eval_env = Env(args.eval_episodes)

logger.info(f"1a) Setup online training envs, online_buffer_size:{args.online_buffer_size}")
...
logger.info("1b) Setup GPT Transformer: ")
...
# used_data_dir:
# '../../offline_data/3s_vs_4z/good/', 
# '../../offline_data/2m_vs_1z/good/', 
